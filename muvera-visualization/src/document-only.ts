...
class DocumentOnlyAnimation {
  ...
  constructor() {
    ...
    // Process document text to get real FDE data
  ...
  private resetAnimation(): void {
    console.log('🔄 Restarting Document animation...');
